# -*- coding: utf-8 -*-
"""Deteccion de Figuras.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1AWMNEkruIy99KtAia9YLHTh258ojtLGh
"""
...
!wget https://raw.githubusercontent.com/DRMiguelAR/UP_Interpretacion/master/orillas/figura3.png
!wget https://raw.githubusercontent.com/DRMiguelAR/UP_Interpretacion/master/orillas/figura4.png
...
def find_figures2(imgName):
  ...
  circulos = cv2.HoughCircles(figuras, cv2.HOUGH_GRADIENT, 2, 100, 100, 250, 100)
  circulos = np.uint16(np.around(circulos))
  cv2.circle(figurasFinal, (circulos[0], circulos[1]), circulos[2], (0, 187, 255), 10)      
  ...
  esquinas = cv2.cornerHarris(fig2,3,5,0.04)
  esquinas = esquinas>esquinas.max()*0.01
...
find_figures2("figura3.png")

find_figures2("figura4.png")